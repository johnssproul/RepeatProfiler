...
| -bowtieflag ""                   | insert  any flags without restricting to the above choices for bowtie2 here between these quotations like:   -bowtieflag "--sensitive-local -no-mixed"|
